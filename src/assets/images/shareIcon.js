...
export default function shareIcon(props) {
    ...
    const Share = `<svg width="53px" height="78px" viewBox="0 0 53 78" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
...
const ShareSVG = () => <SvgXml xml={Share} />
  return (
    <ShareSVG/>
  )
}