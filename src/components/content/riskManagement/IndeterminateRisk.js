    ...
    <>
      ...
      <MainContent>
        ...
        <TextBasic 
          ...
          textAlign="left"
        >
          {`\u2022 Weight loss recommended if overweight or obese\u00B9: Greater need for structured weight loss programs, anti-obesity medications, bariatric surgery `}
        </TextBasic>
        <TextBasic 
          marginVertical={5}
          textAlign="left"
      ...
      <BottomContent>
        <TextBasic 
          ...
          textAlign="left"
        >
          Refer to hepatologist for liver biopsy or MR elastography. May consider monitoring with re-evaluation of risk in 2-3 years.
        </TextBasic>
      </BottomContent>
    </>
  );
